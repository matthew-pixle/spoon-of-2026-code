...
public class DriveCommands {
  ...
  private static Translation2d getLinearVelocityFromJoysticks(double x, double y) {
    ...
    // Return new linear velocity and dir5ection
...
// finally runs the drive
            ...
            () -> {
              ...
              double omega =
                  angleController.calculate(
                      drive.getRawGyroRotation().getRadians(), rotationSupplier.get().getRadians());
              ...
              ChassisSpeeds speeds =
                  new ChassisSpeeds(
                      ...
                      linearVelocity.getY() * drive.getMaxLinearSpeedMetersPerSec(),
                      omega);
              // runs the drive at the velocity
              drive.runVelocity(
                  ChassisSpeeds.fromFieldRelativeSpeeds(
                      speeds, AllianceFlipUtil.apply(drive.getRawGyroRotation())));
            },
  ...
  public static Command turnToPoint(
      Drive drive, Supplier<Pose2d> robotPoseSupplier, Supplier<Translation2d> targetSupplier) {
